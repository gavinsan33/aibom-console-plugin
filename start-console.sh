...
# Plugin metadata is declared in package.json. Read it directly rather than
# relying on npm_package_consolePlugin_name -- Yarn Berry (unlike npm/Yarn
# Classic) doesn't inject npm_package_* env vars for `yarn run` scripts.
